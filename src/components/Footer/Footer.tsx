...
export default function Footer() {
  ...
  return (
    <div className="mt-10 w-full border-t-[1px] dark:border-t-neutral-800 border-t-slate-200 py-5">
      <div
        dir="ltr"
        className=" [@media(max-width:1200px)]:w-[95%] [@media(min-width:1400px)]:w-[1400px] w-[80%] mx-auto flex [@media(max-width:991px)]:flex-col gap-y-5 items-center justify-between"
      >
        <FooterImageSign />
        <h5 className="text-center font-[400] dark:text-slate-400 text-slate-700 text-md">
          {lang === "en" ? en.footer.title : fa.footer.title}
        </h5>
