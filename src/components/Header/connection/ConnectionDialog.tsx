...
export default function ConnectionDialog() {
      ...
      <AnimatePresence>
        {isShowDialog && (
          ...
          dir={lang === "en"? "ltr": "rtl"}
            ...
            className={`${lang === "en"? "font-inter" : "font-iransans"} z-[9999] fixed [@media(min-width:980px)]:hidden visible bottom-0 rounded-lg dark:bg-background-dark dark:text-white text-black bg-neutral-100 flex flex-col items-start w-full gap-y-5 
          dark:border-neutral-800 border-[#E2E8F0] border-[0.5px] p-4 ${
            lang === "en" ? "right-0" : "left-0"
          }`}
          >
  ...
  return (
    <div className="[@media(min-width:980px)]:relative">
      ...
      {mounted && createPortal(mobilePortal, document.body)}
    </div>
  );
}
