...
export default function HeroSection() {
  ...
  const { lang } = useLang();
  return (
    <div className="flex [@media(max-width:980px)]:flex-col-reverse items-center gap-y-3 justify-between w-full mx-auto">
      ...
      <motion.div className="relative h-full sm:w-[400px] w-[80%] rounded-full bg-gradient-to-br from-primary-light/35 via-sky-200/25 to-cyan-300/20 p-[3px] shadow-[0_24px_70px_-35px_rgba(77,107,254,0.9)] dark:from-primary-dark/40 dark:via-orange-300/10 dark:to-amber-300/10 dark:shadow-[0_24px_70px_-35px_rgba(255,126,61,0.95)]">
