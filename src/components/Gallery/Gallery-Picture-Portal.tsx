      ...
      {isShowPortal ? (
        <>
          <motion.div
            ...
            className={`z-[9999] fixed top-[50%] overflow-hidden [@media(min-width:800px)]:w-[800px] w-[95%] h-auto right-[50%] translate-y-[-50%] translate-x-[50%] border-[1px] dark:border-slate-700 border-slate-300 dark:bg-slate-900 bg-slate-100 rounded-lg p-3  dark:text-white text-black flex flex-col items-center ${
